const questions = [
    ...
    "מאור נמצא במערכת יחסים כבר כמה חודשים, כאשר הוא אוהב את בת זוגתו אך מרגיש שלפעמים הוא לא מרוצה ממנה ומחפש תשומת לב מנשים אחרות. מצד אחד מאור לא רוצה לפגוע במערכת היחסים שלו עם בת זוגתו אבל מצד שני הוא מרגיש דחף חזק להשיג תשומת לב ומגע מאנשים אחרים. כיצד ניתן להסביר את הדילמה שבו נמצא מאור על פי התאוריה של פרויד?",
    "הסבירו מה הוא עקרון המוסר ותנו דוגמה למשהו שעקרון המוסר משפיע עליו.",
    "הסבירו מהו קיבעון ואיך אדם עשוי לפתח קיבעון.",
    "הסבירו מהם ההבדלים בין הלא מודע למודע.",
    "תינוק בשלב האורלי לא מקבל את היחס התואם את השלב מהוריו, הוא כל הזמן בוכה והם לא יודעים מה לעשות. הסבירו איזה יחס הוא צריך לקבל, הסבירו מה קורה בשלב הזה, ומה ייקרה אם הוא לא יקבל את היחס הנכון/מה יקרה אם הוא לא יצליח לפתור את השלב.",
    "נדב שיחק עם קבוצתו במשחק כדורגל נגד קבוצה יריבה, נדב וקבוצתו ניצחו במשחק. הסבירו איך הם ירגישו לפי אני האידאלי והסבירו מה הוא האני האידאלי.",
    "ילד מרגיש שהוא נמשך לאמו, הוא רוצה שהיא תהיה שלו ורואה באביו בתור מתחרה. הסבירו באיזה שלב מהשלבים הפסיכוסקסואליים הוא נמצא, מה הוא תסביך אדיפוס ולמה תסביך אדיפוס לא פתור יוביל.",
    ...
    "אורן ושרון, שני סטודנטים לפסיכולוגיה, למדו יחד על המודל הטופוגרפי של פרויד. במהלך השיעור, שרון שאלה את המרצה איך אפשר להבין את המאבקים הפנימיים של אדם על ידי זיהוי הרמות השונות בנפש. מהו המאבק הפנימי שמתרחש בין המודע ללא-מודע, לפי המודל של פרויד?",
    "מיה, עורכת דין צעירה, הרגישה מאבק פנימי בעבודתה. היא רצתה להתקדם, אך היו לה דחפים לא מודעים להימנע מעימותים ולפעמים תחושות אשמה לגבי החלטות קשות. חברה שלה, תמר, הסבירה לה על המודל המבני של פרויד, שבו כל חלק בנפש תורם להתנהגות. כיצד הדחפים הלא-מודעים של מיה משפיעים על ההתנהגות שלה בעבודתה? כיצד הסופר-אגו של מיה משפיע על תחושת האשם שלה במקרים של קבלת החלטות קשות?",
    "רות, עורכת דין מצליחה, מצאה את עצמה מתמודדת עם דילמה מוסרית בעבודתה. היא ייצגה לקוח שמעורב במקרה רגיש, ורצתה להצליח ולהשיג את טובת הלקוח. אך היא התלבטה, היא לא יכלה להימנע מהמחשבה על ההשלכות המוסריות של ההגנה על אדם שחושבת שהוא לא בנכון. תחושת הבלבול והמנוגדות גרמה לה לאי-נוחות פנימית. כיצד האגו של רות מנסה להתמודד עם הדחף להצליח תוך שמירה על המסגרת המקצועית?"
];
