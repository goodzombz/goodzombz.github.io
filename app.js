const questions = [
    ...
    "מאור נמצא במערכת יחסים כבר כמה חודשים, כאשר הוא אוהב את בן זוגתו אך מרגיש שלפעמים הוא לא מרוצה ממנו ומחפש תשומת לב מנשים אחרות. מצד אחד מאור לא רוצה לפגוע במערכת היחסים שלו עם בת זוגתו אבל מצד שני הוא מרגיש דחף חזק להשיג תשומת לב ומגע מאנשים אחרים. כיצד ניתן להסביר את הדילמה שבו נמצא מאור על פי התאוריה של פרויד?"
];
